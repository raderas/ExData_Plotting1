...
plot(timedata,filtrado$Voltage,ylab="Voltage",xlab="datetime",type="l")
...
plot(timedata,filtrado$Global_reactive_power,ylab="Global_reactive_power",xlab="datetime",type="l")
